  ...
  return (
    <>
      <ListItem bottomDivider containerStyle={styles.containerNightStyles}>
        ...
        <ListItem.Content>
          <ListItem.Title style={styles.listItemTitle}>{STRINGS.larivaar}</ListItem.Title>
        </ListItem.Content>
      ...
      {isLarivaar && (
        <ListItem bottomDivider containerStyle={styles.containerNightStyles}>
          ...
          <ListItem.Content>
            <ListItem.Title style={styles.listItemTitle}>{STRINGS.larivaar_assist}</ListItem.Title>
          </ListItem.Content>
          <Switch
